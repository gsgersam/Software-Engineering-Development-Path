# Software Engineering Development Path 

This repository serves as a comprehensive **Technical Portfolio** documenting my professional growth and architectural decisions during my engineering training at **École 42 Luxembourg**.

##  Intellectual Property & Integrity
To respect academic integrity and the internal rules of École 42, the **source code for these projects is maintained in private repositories**. 
This public space showcases the **Engineering Design**, **Logic Architecture**, and **System Documentation** behind each challenge. It demonstrates my ability to design, document, and maintain complex software systems.
...
* **Infrastructure as Code**  
  Step-by-step guide for Virtual Machine setup and Docker orchestration (Inception).

* **Networking Guide**  
  Practical approach to network configuration and subnetting (NetPractice).
...
* **Languages:** C, C++  
* **Systems:** Unix/Linux, Shell Scripting, Docker, Virtualization  
* **Focus:** Data Integrity, Performance Optimization, Technical Documentation  
...
*Developed with focus and rigor by German Andres Sanin M*
